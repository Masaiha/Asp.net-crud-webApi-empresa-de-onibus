...
namespace Ubus.Data.Migrations
{
    ...
    [Migration("20201008135100_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ubus.Business.Entities.TripDriver", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ubus.Business.Entities.Driver", b =>
                {
                    b.HasOne("Ubus.Business.Entities.TripDriver", "TripDriver")
                        .WithMany("Drivers")
            ...
            modelBuilder.Entity("Ubus.Business.Entities.TripDriver", b =>
                {
                    b.HasOne("Ubus.Business.Entities.Trip", "Trip")
                        .WithOne("TripDriver")
                        .HasForeignKey("Ubus.Business.Entities.TripDriver", "TripId")
                        .IsRequired();
                });
